...
public class TestCases {
     ...
     * 一半胜率
     */
    public static Simulator test2() {
        final int attack = 1240;
        Camp red = new PVPCamp(TestCases.redName, 3);
        Camp blue = new PVPCamp(TestCases.buleName, 3);
        red.addEntity(new BiAnHua(new Property(attack, 10000, 400, 173, 1, 1.5, 0, 0), new ZhenNv()));
        red.addEntity(new HuiYeJi(new Property(attack, 10000, 400, 172, 0, 1.5, 0, 0), new HuoLing()));
        blue.addEntity(new BoRe(new Property(attack, 10000, 400, 171, 0.8, 1.5, 0.1, 0), new DiZangXiang()));  // 效果命中影响大
        blue.addEntity(new GuHuoNiao(new Property(attack, 10000, 400, 170, 0.8, 1.5, 3, 0), new MeiYao()));
        return new BattleSimulator(red, blue);
    }
}
